...
const Navbar = () => {
  ...
  return (
    <nav
      className={`p-4 w-full z-50 transition-all duration-500 ease-in-out overflow-x-hidden animate-fade-down ${navbarFixed
      ...
      <div className="container mx-auto flex items-center animate-fade-down">
        ...
        <div className="flex items-center flex-grow w-32 animate-slide-right-l">
          <img
            ...
            alt="Logo"
            className={`w-80 -ml-20 transition duration-500 ${navbarFixed ? "invert" : ""
              }`}
          />
        </div>
        ...
        <ul className="flex space-x-16 flex-grow justify-center">
          ...
          <li>
            <a href="#features" className="text-l font-medium  hover:underline">
              Features
            </a>
          </li>
          <li>
            <a href="#pricing" className="text-l font-medium  hover:underline">
              Pricing
            </a>
          </li>
          <li>
            <a href="#faq" className="text-l font-medium hover:underline">
              FAQ
            </a>
          </li>
        </ul>
