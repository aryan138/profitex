  ...
  return (
    <div className="container mx-auto p-4 flex justify-center animate-fade">
      <div className="inline-block w-[39%] align-top">
        <img className='h-[100%] w-[100%] transform translate-x-[50px] animate-slide-right' src="https://res.cloudinary.com/ddwxpd7yp/image/upload/v1725361880/inventoryimg_kidjkn.png" alt="feature1" />
      </div>
      <div className="inline-block w-[39%] align-top">
        <div className="block m-[12%] mx-[14%] w-[71%] animate-slide-left">
          <h1 className='font-semibold text-2xl mb-2'>Inventory Management</h1>
